...
export default function Navbar(props) {
  ...
  return (
    <>
     <div className={`bg-gray-50 text-${props.mode1} bg-${props.mode} `} id="yashnavbar">
  ...
  <div class=" flex flex-wrap items-center justify-between mx-10 px-4 py-3 md:mx-5 lg:mx-20 min-[270px]:m-1 max-[640px]:m-1">
    ...
    <a href="#" class="flex items-center space-x-3">
        <span className={`self-center text-2xl font-bold text-4xl text-blue-700 text-${props.mode1}`}>TextUtils</span>
    </a>
    </div>
    ...
    <div onClick={props.toggleMode} className="cursor-pointer">
        ...
        <img src={sunny} className="w-8 mt-1 min-[270px]:block max-[640px]:block" onClick={props.toggleMode} alt="" />
      </div>
      <button data-collapse-toggle="navbar-hamburger"  type="button" className={`inline-flex bg-${props.mode} items-center justify-center p-2 w-10 h-10 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 min-[270px]:block max-[640px]:block md:hidden`} aria-controls="navbar-hamburger" aria-expanded="false" onClick={toggleHamburger}>
...
{hamburg && (
        <div className={`ham xl:hidden w-full lg:hidden sm:block md:hidden min-[240px]:block max-[640px]:block" data-dropdown-toggle="dropdownToggle" id="navbar-hamburger`}>
          <ul className={`flex bg-${props.mode} text-${props.mode1} flex-col font-medium mt-0 rounded-lg bg-gray-50`}>
            ...
            <li>
              <a href="#" className={`block text-${props.mode1} py-2 px-3 text-gray-900 rounded hover:bg-blue-700 mb-0.5 mx-2 hover:text-white min-[270px]:text-center max-[640px]:text-center`}>Services</a>
            </li>
            <li>
              <a href="#" className={`block text-${props.mode1} py-2 px-3 text-gray-900 rounded hover:bg-blue-700 mb-0.5 mx-2 hover:text-white min-[270px]:text-center max-[640px]:text-center`}>Pricing</a>
            </li>
            <li>
              <a href="#" className={`block text-${props.mode1} py-2 px-3 text-gray-900 rounded hover:bg-blue-700 mb-0.5 mx-2 hover:text-white min-[270px]:text-center max-[640px]:text-center`}>Contact</a>
            </li>
          </ul>
        </div>
      )}
      ...
      <div className={`bg-gray-00  bg-${props.mode}`} >
        ...
        <div className="section mx-48 py-20 p-5 justify-between flex gap-4 flex-wrap lg:mx-10 xl:mx-48 md:mx-0 sm:mx-0 sm:text-center min-[270px]:mx-0 max-[640px]:mx-0 min-[270px]:text-center max-[640px]:text-center">
          <div className="left_side lg:w-6/12 p-3 md:w-full md:text-center lg:text-left sm:text-center sm:w-full min-[270px]:w-full min-[270px]:text-xl sm:text-2xl border-dashed">
            ...
            >
              <span className="text-pink-600 "  style={{color:props.mode === 'light'?'#e70074':'white'}}>Are you ready for </span>
              <br /> <span className="text-green-700"  style={{color:props.mode === 'light'?'green':'blue'}}>Best Online Tool?</span>
            </h1>
            <p className="text-xl font-normal pb-7 text-gray-600"  style={{color:props.mode === 'light'?'#4a4343':'#dccece'}}>
      ...
      <div className={`heading bg-gray-00 text-center font-bold p-8 pt-6 bg-${props.mode}`} >
        <h1
