...
export default function Navbar(props) {
  ...
  return (
    <>
     ...
     <nav class="border-gray-200 bg-gray-0 dark:bg-gray-800 dark:border-gray-700 md:mx-5 lg:mx-20 min-[270px]:m-1 max-[640px]:m-1">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-3">
    <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white text-4xl text-blue-700 ">TextUtils</span>
    </a>
    <div className="lists md:block sm:hidden min-[270px]:hidden max-[640px]:hidden " >
...
{hamburg && (
      ...
      <div className="heading bg-gray-100 text-center font-bold p-8 pt-6">
        <h1
